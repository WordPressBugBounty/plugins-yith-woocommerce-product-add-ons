...
! defined( 'YITH_WAPO_VERSION' ) && define( 'YITH_WAPO_VERSION', '4.19.0' );
...
! defined( 'YITH_WAPO_DB_VERSION' ) && define( 'YITH_WAPO_DB_VERSION', '4.19.0' ); // Do not update the version for WC updates.
